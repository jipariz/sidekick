...
/**
 * Release-variant stub for `kermitLogMonitor`. Returns a no-op [LogMonitorPlugin] and intentionally
 * does NOT call `Logger.setLogWriters` — production builds keep their original Kermit setup
