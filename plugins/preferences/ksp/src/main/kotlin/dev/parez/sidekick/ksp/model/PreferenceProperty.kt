...
/**
 * `defaultValue` is a *Kotlin-source-form* literal: e.g. `false`, `42`, `0.5f`, `"hi"`, or
 * the enum entry name (without the type prefix) like `DEFAULT`. The generators emit it
 * verbatim into the generated Kotlin, so it must already be valid Kotlin for the property's
 * type — see DefaultExtractor for the parsing rules.
 */
