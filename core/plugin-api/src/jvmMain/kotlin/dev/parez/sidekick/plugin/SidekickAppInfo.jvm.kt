 ...
 *
 * Captures OS name/version, JVM version, and processor count in [PlatformInfo.Desktop]. App-level
 * info (version, build type) is not available at runtime on Desktop; use [withExtras] to surface
 * those values:
 * ```kotlin
