...
/**
 * Parses a human-readable browser name from a `navigator.userAgent` string. Order matters: Edge and
 * Opera both contain "Chrome", so they must be checked first.
 */
internal fun parseBrowserName(ua: String): String? =
    when {
