...
<p align="center">
  <img src="docs/assets/screenshots/hero.png" alt="Sidekick panel open over a Pokémon catalog app" width="800"/>
</p>
...
| | |
|---|---|
| <img src="docs/assets/screenshots/network-monitor.png" alt="Network Monitor" width="420"/> | <img src="docs/assets/screenshots/log-monitor.png" alt="Log Monitor" width="420"/> |
| **Network Monitor** — filter by method, search by URL, pretty-print JSON bodies. | **Log Monitor** — level chips, color-coded badges, copyable stacktraces. |
| <img src="docs/assets/screenshots/preferences.png" alt="Preferences" width="420"/> | <img src="docs/assets/screenshots/custom-screens.png" alt="Custom Screens" width="420"/> |
| **Preferences** — type-safe accessors via KSP, inline editors per type. | **Custom Screens** — wrap any Composable in a first-class debug card. |

<sub>Screenshots are generated by <code>bash scripts/capture-screenshots.sh</code>. Re-capture after UI changes; see <a href="docs/assets/screenshots/README.md">docs/assets/screenshots/README.md</a>.</sub>
...
| [Quick start](docs/quick-start.md) | Wire-up snippet, header customization, `appInfo`, `initialPluginId`. |
